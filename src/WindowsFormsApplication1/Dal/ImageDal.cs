...
namespace WordpressScraper.Dal
{
    public class ImageDal
    {
        ...
        public string InsertSql(ImagePost image, string ftpDir)
        {
            ...
            var attachmentMetaDataFormat = "a:5:{{" +
                "s:5:\"width\";i:{0};" +
                "s:6:\"height\";i:{1};" +
                "s:4:\"file\";s:{8}:\"{2}\";" +
                "s:5:\"sizes\";a:3:{{" +
                    "s:9:\"thumbnail\";a:4:{{" +
                        "s:4:\"file\";s:15:\"{7}-{3}x{4}{5}\";" +
                        "s:5:\"width\";i:{3};" +
                        "s:6:\"height\";i:{4};" +
                        "s:9:\"mime-type\";s:10:\"{6}\";" +
                        "}}" +
                    "s:6:\"medium\";a:4:{{" +
                        "s:4:\"file\";s:15:\"{7}-164x300{5}\";" +
                        "s:5:\"width\";i:164;" +
                        "s:6:\"height\";i:300;" +
                        "s:9:\"mime-type\";s:10:\"{6}\";}}" +
                    "s:13:\"excerpt-thumb\";a:4:{{" +
                        "s:4:\"file\";s:15:\"{7}-191x350{5}\";" +
                        "s:5:\"width\";i:191;" +
                        "s:6:\"height\";i:350;" +
                        "s:9:\"mime-type\";s:10:\"{6}\";" +
                        "}}" +
                ...
                "s:10:\"image_meta\";a:11:{{" +
                    ...
                    "}}" +
                "}}";
            var attachmentMetaData = string.Format(attachmentMetaDataFormat, 
                image.Width, 
                image.Height, 
                attachFile,
            ...
            return string.Format(
                ...
                "open", "closed",
                "", image.Title.EscapeSql(), "", "", DateTime.Now.ToString("yyyy-MM-dd HH':'mm':'ss"), DateTime.Now.ToString("yyyy-MM-dd HH':'mm':'ss"), "", 0, image.Url, 0,
