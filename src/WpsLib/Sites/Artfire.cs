...
namespace WpsLib.Sites
{
    public class Artfire : Site
    {
        ...
        public override Item.Item GetItem(string title, string url, string extraInfo)
        {
        ...
        protected override void SetCreatedDate(HtmlDocument htmlDoc, Item.Item item)
        {
